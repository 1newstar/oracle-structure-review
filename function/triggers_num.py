...
示例
    ...
    v_result = f_rule_triggers_num(v_parms)
说明
...
************************************************************"""
def f_rule_triggers_num(p_parms):
    ...
    cursor = conn.cursor()
    cursor.execute("""select trigger_name from dba_triggers where owner='"""+l_username+"""'""" )
